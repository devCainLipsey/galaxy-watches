        ...
        <div className="flex flex-col justify-center items-center">
          <div className="w-full h-96 rounded-lg overflow-hidden relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <h1 className="text-6xl  font-galaxy text-center text-white max-[552px]:mt-10 max-[410px]:text-4xl">
              ...
              <Link href="/Shop">
                <div className="w-64 relative inline-flex group mt-8 max-[552px]:mb-16 ">
          ...
          <div className=" mt-40 relative ml-[33rem] max-[1300px]:ml-[5rem] max-[790px]:ml-[4.5rem]  max-[790px]:w-[600px] max-[670px]:mt-20  max-[670px]:w-[450px] max-[670px]:ml-[2.5rem]  max-[490px]:w-[400px] max-[490px]:mr-[1rem]  max-[430px]:mt-20  max-[420px]:w-[350px] max-[420px]:mr-[2rem]">
