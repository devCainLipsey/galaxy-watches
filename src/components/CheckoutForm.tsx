...
import OrderPlacedOverlay from "./OrderPlacedOverlay";
...
const CheckoutForm: React.FC = () => {
  ...
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (allFieldsFilled) {
      console.log("All fields are filled. Showing OrderPlacedOverlay.");
      setShowOverlay(true);
      // Add a 3-second delay before redirecting to home page
      setTimeout(() => {
        window.location.href = "/"; // Replace "/" with your home page URL
      }, 3000); // 3000 milliseconds = 3 seconds
    } else {
      console.log("Some fields are missing. Showing FillOutFieldsOverlay.");
  ...
  return (
    <>
      ...
      */}
      ...
      {showOverlay && <OrderPlacedOverlay onClose={handleCloseOverlay} />}
